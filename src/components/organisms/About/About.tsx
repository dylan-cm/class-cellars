  ...
  return (
    <div className="About">
      <div className="TopRow">
        ...
        <p className="Blurb">
          The mission of Classified Cellars is to offer only the finest bottles
          of the world’s rarest wines. Before acquiring a bottle for our
          inventory we ask ourselves if this is a wine we predict will exceed
          our buyer’s expectations when it is opened for that special occasion.
          <br />
          <br />
